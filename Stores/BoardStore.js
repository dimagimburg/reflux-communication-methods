...
let Store = Reflux.createStore({
    ...
    init() {
        // init is called before the component bound so the store stores the data
        // before the component has it and provides it by "getter" function: see getBoard()
        this.board = getDefaultBoard(5); 
    },

    getBoard() {
        // getter function, an API to the component, called in the getInitialState
        return this.board;
    },
